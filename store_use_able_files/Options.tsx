import { ArrowDown, ArrowUp, Blend, BookType, Component, Folder, Home, Image, LayoutDashboardIcon, LayoutTemplate, Minus, Palette, Settings, ShapesIcon, Sparkle, Square, SquareRoundCorner, Trash, Type, Wallet, WalletCardsIcon } from "lucide-react";
